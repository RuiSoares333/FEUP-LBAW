...
INSERT INTO users (id, username, email, password, country, is_admin) VALUES(5, '[redacted]', 'redac@legitmail.com', '$2a$12$gc7M2CUhl8QwvbsEkhaXW.aLeShBasRXwYPXqjiZoid/PrwZTvVCe', '', false); --id 5 is deleted user
INSERT INTO users (id, username, email, password, country, is_admin) VALUES(6, 'John Doe', 'admin@example.com', '$2y$10$HfzIhGCCaxqyaIdGgjARSuOKAcm1Uy82YfLuNaajn6JrjLWy9Sj/W', 'Chad', true);
